function ma1_page_thru_trials_binoriv_fixation(runpath, list_successful_only, plot_trials, plot_2D, plot_summary, detect_saccades, detect_saccades_custom_settings)
